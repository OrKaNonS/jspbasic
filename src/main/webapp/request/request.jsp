...
<%
  ...
  System.out.println(request.getContentLength());		// 전송한 데이터길이
  ...
  System.out.println(request.getLocalPort());			// 톰캐포트번호
  System.out.println(request.getProtocol());			// 프로토콜명/버젼
  System.out.println(request.getQueryString());			// GET으로 URL위에 붙인 데이터
  System.out.println(request.getRemoteAddr());			// 원격지 주소
  System.out.println(request.getRemoteHost());			//원겨호스트명
%>